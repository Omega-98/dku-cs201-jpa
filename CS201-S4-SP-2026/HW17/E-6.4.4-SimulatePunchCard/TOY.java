    ...
    public void run() {
        ...
        while (true) {
            ...
            if ((addr == 255 && op == 8) || (reg[t] == 255 && op == 10)){
                ...
                b=b.replace('-','0');
                String news=a+b;
                int binary=Integer.parseInt(news,2);
                String hexStr = Integer.toHexString(binary);
            ...
            if ((addr == 255 && op == 9) || (reg[t] == 255 && op == 11)){
                int res=mem[255];
                String binaryStr = String.format("%16s", Integer.toBinaryString(res)).replace(' ', '0');
                binaryStr=binaryStr.replace('0','-').replace('1','*');
                System.out.println(binaryStr.substring(0, 8));
                System.out.println(binaryStr.substring(8));
            }
